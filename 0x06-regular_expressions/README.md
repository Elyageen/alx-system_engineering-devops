تم استخدام 93‎%‎ من مساحة التخزين … إذا نفدت مساحة التخزين، لن يكون بإمكانكِ إنشاء الملفات أو تعديلها أو تحميلها. استفيدي من مساحة تخزين بسعة 100 غيغابايت مقابل ‏٦٫٩٩ ر.س.‏‏ ‏١٫٧٥ ر.س.‏ شهريًا لمدة 3 أشهر.
README.md‏
# Regular expression
